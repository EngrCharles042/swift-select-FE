...
export const Education = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("/job-seeker/create-profile/education", formData, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem("token")}`
                }
            }).then(
                response => {
                    SweetAlert('success', 'Update Successful', 'Your Education information has been updated successfully');
