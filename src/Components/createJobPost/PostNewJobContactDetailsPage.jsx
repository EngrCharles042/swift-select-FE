...
export const PostNewJobContactDetailsPage = ()=> {
    return (
        <div className="items-start flex flex-col w-fit mx-auto relative">
            <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/ae2c5c60-7d3a-4029-9c40-12e1fd921dd6?"
                className="aspect-square object-contain w-8 overflow-hidden shrink-0 max-w-full self-end absolute"
            />
