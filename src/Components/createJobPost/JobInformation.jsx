    ...
    return (
        <div>
            <form className="w-fit mx-auto flex flex-col">
                <div className="relative top-2 text-blue-500 text-sm leading-5 tracking-normal whitespace-nowrap flex justify-center items-stretch bg-white w-fit px-1 mx-4 mt-5">
                    Job Title
                </div>
                <input
                    type="text"
