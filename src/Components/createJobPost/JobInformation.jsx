...
export const JobInformation = ({handleChange, formData, countries, handleStep2}) => {

    return (
        <div className="mb-[4rem] w-fit mx-auto flex flex-col">
            ...
            <input
                type="number"
                name="numOfPeopleToHire"
                value={formData.numOfPeopleToHire}
                onChange={handleChange}
                className="text-black text-base leading-6 tracking-normal whitespace-nowrap rounded border border-[color:var(--Blue-1,#2F80ED)] self-center w-[500px] max-w-full px-4 py-2.5 border-solid"
            ...
            <div
                className="justify-end items-stretch rounded border self-center flex w-[500px] border-[color:var(--Blue-1,#2F80ED)] max-w-full gap-5 border-solid max-md:flex-wrap">
                <select
                    name="jobCategory"
            ...
            <div className=" w-[500px] items-stretch gap-2 self-center flex justify-between relative max-md:flex-wrap">
            ...
            <button onClick={handleStep2} className="text-white text-base font-semibold leading-6 tracking-normal whitespace-nowrap justify-center items-stretch bg-blue-500 w-[104px] max-w-full mt-8 px-4 py-2 rounded-xl self-end">
                Continue
            </button>
        </div>
    );
